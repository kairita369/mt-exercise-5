...
subword-nmt apply-bpe -c data2/code2000.bpe < data2/train.en | subword-nmt get-vocab > data2/bpe_vocab2000.en
subword-nmt apply-bpe -c data2/code2000.bpe < data2/train.it | subword-nmt get-vocab > data2/bpe_vocab2000.it
